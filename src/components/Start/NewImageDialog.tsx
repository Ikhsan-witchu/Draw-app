...
export default function NewImageDialog({ onCreate, onCancel }: NewImageDialogProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-8 z-50" onClick={onCancel}>
      <div
        className="w-full max-w-2xl bg-neutral-950 border border-neutral-800 rounded-lg p-6"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between mb-1">
          <h1 className="text-neutral-200 text-lg">Dokumen baru</h1>
